...
namespace SuperCode.Utils
{
    ...
    public class ConfigHelper
    {
        ...
        */
        ...
        /// <returns></returns>
        public IConfiguration Load(string fileName, string filePath = "", string environmentName = "", bool reloadOnChange = false)
        {
            if (filePath.IsNull())
            {
                filePath = Path.Combine(AppContext.BaseDirectory, "configs");
            }
        ...
        /// <param name="reloadOnChange">自动更新</param>
        /// <returns></returns>
        public T Get<T>(string fileName, string filePath = "", string environmentName = "", bool reloadOnChange = false)
        {
            var configuration = Load(fileName, filePath, environmentName, reloadOnChange);
        ...
        /// <param name="environmentName">环境名称</param>
        /// <param name="reloadOnChange">自动更新</param>
        public void Bind(string fileName, object instance, string filePath = "", string environmentName = "", bool reloadOnChange = false)
        {
            var configuration = Load(fileName, filePath, environmentName, reloadOnChange);
